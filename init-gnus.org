...
(setq nnimap-split-inbox "INBOX") ;; (1)
 ...
 (setq nnimap-split-rule
       '(
         ("INBOX.spam" "^Subject:.*Automatischer Spam-Report")
         ("INBOX.work" "^To:.*Christian.Groll@stat.uni-muenchen.de")
         ("INBOX.gmail" "^To:.*cgroll.ger@gmail.com")
         ("INBOX.gmx" "^To:.*cgroll@gmx.de")
         ("INBOX.lokalisten" "^From:.*support@lokalisten.de")    
         ("INBOX.misc" "")   
        ))
...
#+BEGIN_SRC emacs-lisp
;; mail number, date
(setq gnus-summary-line-format "%U%R%z%I%(%[%4N][%z|%d: %-23,23f%]%) %s\n")
