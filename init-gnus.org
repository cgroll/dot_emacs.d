...
#+BEGIN_SRC emacs-lisp 
  ;; define split fancy for lrz server
  (setq nnimap-split-fancy
     '(|
         (: nnmail-split-fancy-with-parent)
         (any "cgroll@gmx.de" "INBOX.private")
         (any "cgroll.ger@gmail.com" "INBOX.private")
         (any "cgroll.ger@googlemail.com" "INBOX.private")
         (any "\\.*[Bb]lokhina" "INBOX.private")
         (any "marco.farsch@derpart.com" "INBOX.private")
         (any "philipp.hell@unicreditgroup.de" "INBOX.private")
         (any "allagnon2001@yahoo.fr" "INBOX.private")
         (any "JOHANNES.LEITZ@ALLIANZ.COM" "INBOX.private")
         (any "alexander.nikolaus.kerscher@gmail.com" "INBOX.private")
         (any "Christian.Groll@stat.uni-muenchen.de" "INBOX.workMAIL")
         (any "alle@stat.uni-muenchen.de" "INBOX.workMLIST") ; mailing list
         (any "mitarb@stat.uni-muenchen.de" "INBOX.workMLIST")
         ("INBOX.workMAIL")
         )
     )
