...
#+BEGIN_SRC emacs-lisp
  (setq ispell-personal-dictionary "~/Dropbox/customs/personal_data/.ispell_english")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
   (defun cg/blog-settings ()
      "change emacs settings for research blog"
      (interactive)
      (set-fill-column 40000)
      (visual-line-mode)
      )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
   (fset 'cg/fix-cite-pandoc
      (lambda (&optional arg) "Keyboard macro." (interactive "p")
      (kmacro-exec-ring-item (quote ([backspace 93 134217744 C-backspace
                                        backspace 4 91 64 134217744 33554448] 0 "%d")) arg)))
   ...
   (defun org-mode-reftex-setup ()
      ...
      (define-key org-mode-map (kbd "C-t f") 'cg/fix-cite-pandoc)
